...
import Pages.AccountPageFindBy;
import Pages.LoginPageFindBy;
import Utilities.CRMBaseClass;


public class CreateAccountFindBy extends CRMBaseClass {
	...
	public void loginCRM() {
		...
		AccountPageFindBy accpage=PageFactory.initElements(driver, AccountPageFindBy.class);
		accpage.accountCreate(excel.getStringValue("Sheet2", 1, 0), excel.getStringValue("Sheet2", 1, 1), excel.getStringValue("Sheet2", 1, 2));
